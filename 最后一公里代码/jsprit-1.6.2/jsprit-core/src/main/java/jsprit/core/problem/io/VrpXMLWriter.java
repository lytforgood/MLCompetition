...
//    public void writePost(String pathAndName,int number) {
...
//                    	System.out.println(solutionPath + "(" + counter + ").routes.route(" + routeCounter + ").act(" + actCounter + ")[@type]"+"--->"+act.getName());
//                       
...
//                        //act.getArrTime()--->到达时间
//                        //act.getEndTime()--->离开时间
//                        System.out.println(solutionPath + "(" + counter + ").routes.route(" + routeCounter + ").act(" + actCounter + ").arrTime"+"--->"+act.getArrTime());
//                        actCounter++;
//                    }
//                    routeCounter++;
//                }
